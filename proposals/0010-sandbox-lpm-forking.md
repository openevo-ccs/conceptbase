...
| `bio-core-k12` / `interdisciplinary-k12` | Recommend a `sandbox/<short-name>` branch-naming convention for forks realized in-repo | Convention only, not enforced by schema |
