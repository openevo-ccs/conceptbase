...
**See also:** [`ccs-graph/docs/case_models_ccs.md`](https://github.com/openevo-ccs/ccs-graph/blob/main/docs/case_models_ccs.md) — an earlier, broader analysis of CASE-as-graph-ontology from a CCS-theory angle, still live and cross-linked (not superseded) per [`lab_manager`'s design note](https://github.com/openevo-ccs/lab_manager/blob/main/docs/design-notes/openevo-graph-and-ccs-graph-design-governance-concept.md).
